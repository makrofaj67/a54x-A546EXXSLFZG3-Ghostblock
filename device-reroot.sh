#!/system/bin/sh
# ==============================================================================
# Samsung Galaxy A54 (A546E) - On-Device Auto-Root & Chroot Launcher
# ==============================================================================
# This script runs directly inside the phone without requiring a PC.
# It can be executed from Termux, via ADB shell, or on startup via Termux:Boot.
# ==============================================================================

LOG_DIR="${HOME:-/data/local/tmp}"
[ -w "$LOG_DIR" ] 2>/dev/null || LOG_DIR="/data/local/tmp"
LOGFILE="$LOG_DIR/reroot.log"
...
if su -c "id" 2>/dev/null | grep -q "uid=0"; then
    ...
    chmod 755 "$TMP_PATH/.ksud-stage" "$TMP_PATH/ksud-"* 2>/dev/null || true
